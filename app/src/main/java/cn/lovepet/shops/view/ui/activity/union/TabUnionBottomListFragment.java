 ...
 * @des 联盟-狗狗
 */
public class TabUnionBottomListFragment extends BaseFragment {
    private static final String TAG1 = TabUnionBottomListFragment.class.getSimpleName();
    ...
    public static TabUnionBottomListFragment newInstance(List<UnionBottomGoodsBean.Dog2catgoods>  dog2catgoods) {
        TabUnionBottomListFragment fragment = new TabUnionBottomListFragment();
...
//            final ImageView ivMiddle = (ImageView) holder.getView(R.id.ivMiddle);
//            final ExpandImageView ivMiddle = (ExpandImageView) holder.getView(R.id.ivMiddle);
            ((ExpandImageView) helper.getView(R.id.ivMiddle)).setImageURI(coverImageUrl);
