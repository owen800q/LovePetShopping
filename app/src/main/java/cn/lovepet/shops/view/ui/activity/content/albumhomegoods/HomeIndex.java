    ...
    public static class ItemInfoListBean implements MultiItemEntity {
        ...
        public int getItemType() {
            if("topBanner".equals(itemType)){
                return ConstantGoods.TYPE_TOP_BANNER;
            }
            else if("iconList".equals(itemType)){
                return ConstantGoods.TYPE_ICON_LIST;
            }
            else if("newUser".equals(itemType)){
                return ConstantGoods.TYPE_NEW_USER;
            }
            else if("jdBulletin".equals(itemType)){
                return ConstantGoods.TYPE_JD_BULLETIN;
            }
            else if("jdSpikeHeader".equals(itemType)){
                return ConstantGoods.TYPE_JD_SPIKE_HEADER;
            }
            else if("jdSpikeContent".equals(itemType)){
                return ConstantGoods.TYPE_JD_SPIKE_CONTENT;
            }
            else if("showEvent".equals(itemType)){
                return ConstantGoods.TYPE_SHOW_EVENT_3;
            }
            else if("findGoodStuff".equals(itemType)){
                return ConstantGoods.TYPE_FIND_GOOD_STUFF;
            }
            else if("type_211".equals(itemType)){
                return ConstantGoods.TYPE_WIDTH_PROPORTION_211;
            }
            else if("type_Title".equals(itemType)){
                return ConstantGoods.TYPE_TITLE;
            }
            else if("type_22".equals(itemType)){
                return ConstantGoods.TYPE_WIDTH_PROPORTION_22;
            }
            else if("type_1111".equals(itemType)){
                return ConstantGoods.TYPE_WIDTH_PROPORTION_1111;
            }
            else if("type_middleBanner".equals(itemType)){
                return ConstantGoods.TYPE_MIDDLE_BANNER;
            }
            else if("showEventFillUp".equals(itemType)){
                return ConstantGoods.TYPE_SHOW_EVENT_FILL_UP;
            }
            else if("findGoodShop".equals(itemType)){
                return ConstantGoods.TYPE_FIND_GOOD_SHOP;
            }
            else if("preferredList".equals(itemType)){
                return ConstantGoods.TYPE_PREFERRED_LIST;
            }
            else if("live".equals(itemType)){
                return ConstantGoods.TYPE_LIVE;
            }
            else if("recommended_ware".equals(itemType)){
                return ConstantGoods.TYPE_RECOMMENDED_WARE;
            }
            return ConstantGoods.TYPE_TITLE;
        }
