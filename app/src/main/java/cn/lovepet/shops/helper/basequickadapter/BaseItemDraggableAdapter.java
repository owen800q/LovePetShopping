...
import cn.lovepet.shops.helper.basequickadapter.callback.ItemDragAndSwipeCallback;
import cn.lovepet.shops.helper.basequickadapter.listener.OnItemDragListener;
import cn.lovepet.shops.helper.basequickadapter.listener.OnItemSwipeListener;
    ...
    public void onBindViewHolder(K holder, int positions) {
        ...
        if (mItemTouchHelper != null && itemDragEnabled && viewType != LOADING_VIEW && viewType != HEADER_VIEW
            ...
            if (mToggleViewId != NO_TOGGLE_VIEW) {
                ...
                if (toggleView != null) {
                    toggleView.setTag(R.id.LP_BaseQuickAdapter_viewholder_support, holder);
                    if (mDragOnLongPress) {
                ...
                holder.itemView.setTag(R.id.LP_BaseQuickAdapter_viewholder_support, holder);
            ...
            mOnToggleViewLongClickListener = new View.OnLongClickListener() {
                ...
                public boolean onLongClick(View v) {
                    if (mItemTouchHelper != null && itemDragEnabled) {
                        mItemTouchHelper.startDrag((RecyclerView.ViewHolder) v.getTag(R.id.LP_BaseQuickAdapter_viewholder_support));
                    }
                    return true;
                }
            };
