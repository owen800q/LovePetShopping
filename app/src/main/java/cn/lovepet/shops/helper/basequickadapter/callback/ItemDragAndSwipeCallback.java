package cn.lovepet.shops.helper.basequickadapter.callback;
...
import cn.lovepet.shops.helper.basequickadapter.BaseItemDraggableAdapter;
...
//    private static final String TAG = ItemDragAndSwipeCallback.class.getSimpleName();
    ...
    public void onSelectedChanged(RecyclerView.ViewHolder viewHolder, int actionState) {
        if (actionState == ItemTouchHelper.ACTION_STATE_DRAG
            ...
            viewHolder.itemView.setTag(R.id.LP_BaseQuickAdapter_dragging_support, true);
        } else if (actionState == ItemTouchHelper.ACTION_STATE_SWIPE
                && !isViewCreateByAdapter(viewHolder)) {
            mAdapter.onItemSwipeStart(viewHolder);
            viewHolder.itemView.setTag(R.id.LP_BaseQuickAdapter_swiping_support, true);
        }
    ...
    public void clearView(RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder) {
        ...
        if (viewHolder.itemView.getTag(R.id.LP_BaseQuickAdapter_dragging_support) != null
                && (Boolean)viewHolder.itemView.getTag(R.id.LP_BaseQuickAdapter_dragging_support)) {
            mAdapter.onItemDragEnd(viewHolder);
            viewHolder.itemView.setTag(R.id.LP_BaseQuickAdapter_dragging_support, false);
        }
        if (viewHolder.itemView.getTag(R.id.LP_BaseQuickAdapter_swiping_support) != null
                && (Boolean)viewHolder.itemView.getTag(R.id.LP_BaseQuickAdapter_swiping_support)) {
            mAdapter.onItemSwipeClear(viewHolder);
            viewHolder.itemView.setTag(R.id.LP_BaseQuickAdapter_swiping_support, false);
        }
    }
