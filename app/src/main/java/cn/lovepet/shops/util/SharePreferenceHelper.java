...
public class SharePreferenceHelper {
    ...
    private SharedPreferences getSharedPreferences(String fileName){
        return context.getSharedPreferences(TextUtils.isEmpty(fileName) ? Constants.SHARE_PREFERENCE_FILE_NAME : fileName, Context.MODE_PRIVATE);
    }
    ...
    public void saveData(Map<String ,String> maps,String fileName){
        ...
        for(Map.Entry<String, String> map:maps.entrySet()){
            ...
            ILog.e(TAG, "存数据==key is "+key+",value is "+value);
